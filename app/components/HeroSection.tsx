			...
			<div className="relative z-10 min-h-screen flex flex-col items-center justify-center px-4 pt-8 md:pt-0">
				<motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-8 md:mb-12">
					<div className="space-y-3 md:space-y-4 mb-6 md:mb-8">
						...
						My journey started as a curious kid obsessed with how games worked.I remeber my mom was the one whosigned me up for my first no-code bootcamp where I built a calculator and instantly knew this was what I wanted to do. At 16 I worked on my family’s hotel website, adding features and seeing how small changes made a real difference. From there I dove headfirst into computer science, building everything from full-stack apps to reinforcement learning agents. I’ve loved every step and I’m more excited than ever to keep building things that make an impact.
						</p>
						<p className="text-base md:text-lg text-gray-500 max-w-2xl mx-auto">
							I'm a recent Grad from <span className="text-blue-400">Carleton University</span>  currently work as a{' '}
							<span className="text-purple-400">Freelance developer </span>
						</p>
					</div>
					<div className="flex flex-wrap justify-center gap-2 md:gap-3 mb-6 md:mb-8">
						...
						<span className="px-3 md:px-4 py-1.5 md:py-2 bg-purple-500/10 rounded-full text-purple-400 text-xs md:text-sm">and more...</span>
					</div>
				</motion.div>
						...
						<div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8">
							...
							>
								...
								<ul className="space-y-1.5 md:space-y-2 text-xs md:text-sm text-gray-400">
									...
									<li className="flex items-center gap-2">
										<div className="w-1.5 h-1.5 bg-purple-500 rounded-full" />
										Data Modeling & SQL/NoSQL Database Architecture (PostgreSQL, Supabase, MySQL)
									</li>
									<li className="flex items-center gap-2">
										<div className="w-1.5 h-1.5 bg-purple-500 rounded-full" />
										Python-based Automation & Serverless Integration
									</li>
								</ul>
							</div>
							...
							<div
								...
								onMouseLeave={() => setSelectedStack(null)}
							>
								<h3 className="text-lg md:text-xl font-semibold mb-3 md:mb-4 text-teal-400">AI & Machine Learning</h3>
								<ul className="space-y-1.5 md:space-y-2 text-xs md:text-sm text-gray-400">
									<li className="flex items-center gap-2">
										<div className="w-1.5 h-1.5 bg-teal-500 rounded-full" />
										Hugging Face Transformers (BERT, GPT2)
									</li>
									<li className="flex items-center gap-2">
										<div className="w-1.5 h-1.5 bg-teal-500 rounded-full" />
										Reinforcement Learning (Q-Learning, Game Agents)
									</li>
									<li className="flex items-center gap-2">
										<div className="w-1.5 h-1.5 bg-teal-500 rounded-full" />
							...
							<div
								...
								onMouseLeave={() => setSelectedStack(null)}
							>
								<h3 className="text-lg md:text-xl font-semibold mb-3 md:mb-4 text-teal-400">Cyber Security</h3>
								<ul className="space-y-1.5 md:space-y-2 text-xs md:text-sm text-gray-400">
									<li className="flex items-center gap-2">
										<div className="w-1.5 h-1.5 bg-teal-500 rounded-full" />
										Exposure to Threat Modeling & SOC Environments
									</li>
									<li className="flex items-center gap-2">
										<div className="w-1.5 h-1.5 bg-teal-500 rounded-full" />
									...
									<li className="flex items-center gap-2">
										<div className="w-1.5 h-1.5 bg-teal-500 rounded-full" />
										Secure Coding & API Access Control
									</li>
								</ul>
							</div>
						</div>
